...
I.installer = {
	...
	Pages = {
		[1] = function()
			...
			-- Show the NaowhUI logo
			PluginInstallFrame.ShowTutorialImage("Interface\\AddOns\\NaowhUI\\Core\\Media\\Textures\\NaowhUILogo.tga")
		...
		[9] = function()
			...
			if not NUI:IsAddOnEnabled("WarpDeplete") then
				PluginInstallFrame.Desc1:SetText("Enable WarpDeplete to unlock this functionality")
		...
		[11] = function()
			...
			PluginInstallFrame.Desc1:SetText("Select your class to install the corresponding WeakAuras:")
			PluginInstallFrame.Desc2:SetText("Your current class is highlighted in green. You can install WeakAuras for any class.")
			
			-- Use the new class selection interface
			PluginInstallFrame.CreateClassButtons()
		end,
		[12] = function()
...
-- Make installer data globally accessible as a backup
_G.NaowhUI_InstallerData = I.installer
